...
print("INICIANDO V142 BASE 500 USD FIX SYNTAX", flush=True)
...
def resumen_total():
    if not historial: return {"total_entradas":0,"ganadas":0,"perdidas":0,"total_mxn":0,"total_usd":0,"mejor_moneda":"-","peor_moneda":"-","mas_entradas":"-","conteo":{},"por_moneda":{}}
...
def home():
    parts=[]
    parts.append('<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width, initial-scale=1"><title>MAQUINA DE HACER DINERO</title><style>')
    parts.append('body{background:#061126;color:#fff;font-family:Arial;padding:10px;margin:0}.titulo{font-size:26px;text-align:center;color:#FFD700;margin:12px 0 4px 0;font-weight:900}.subtitulo{font-size:9px;color:#8aa;text-align:center;letter-spacing:3px;margin-bottom:12px}.card{background:#0c1e3a;border-radius:16px;padding:14px;margin:12px 0;border:1px solid #14365f}.btn{padding:9px 14px;border-radius:10px;border:none;margin:4px;font-weight:bold;cursor:pointer}.on{background:#0ea5e9;color:#fff}.off{background:#0f284a;color:#5a7aa5}.tp{background:#00e5ff;color:#000;font-weight:900}.buy{background:#00ff88;color:#000;font-weight:900;font-size:11px}.sell{background:#ff3b30;color:#fff;font-weight:900;font-size:11px}.circle-wrap{position:relative;width:270px;height:270px;margin:18px auto}.bg{fill:none;stroke:#0f284a;stroke-width:14}.prog{fill:none;stroke:#FFD700;stroke-width:14;stroke-linecap:round;transform:rotate(-90deg);transform-origin:50% 50%}.center{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);text-align:center}.mxn-big{font-size:44px;color:#00ff88;font-weight:900;line-height:1}.usd-small{font-size:11px;color:#5a7aa5;margin-top:4px}.acum-mxn{font-size:48px;color:#00ff88;font-weight:900;text-align:center;line-height:1}.acum-usd{font-size:13px;color:#5a7aa5;text-align:center}.table{width:100%;border-collapse:collapse;margin-top:10px;font-size:11px}.table th{background:#0f284a;color:#FFD700;padding:8px 4px;text-align:center;font-size:9px}.table td{padding:7px 4px;border-bottom:1px solid #14365f;text-align:center}.comp{background:#00ff88;color:#000;padding:12px;border-radius:12px;font-weight:900;text-align:center;margin:8px 0;font-size:16px}.badge-mxn{color:#00ff88;font-weight:900}.scroll{overflow-x:auto}.resumen{background:#102a4a;border:2px solid #FFD700;border-radius:16px;padding:14px;margin:14px 0}</style></head><body>')
    parts.append('<div class="titulo">MAQUINA DE HACER DINERO</div><div class="subtitulo">BASE 500 USD REAL + CONVERSION MXN - BOLA DE NIEVE ORIGINAL</div>')
    parts.append('<div class="circle-wrap"><svg width="270" height="270"><circle class="bg" cx="135" cy="135" r="110"></circle><circle id="pc" class="prog" cx="135" cy="135" r="110" stroke-dasharray="691" stroke-dashoffset="691"></circle></svg><div class="center"><div style="font-size:9px;color:#8aa;letter-spacing:2px">BASE 500 USD + ACUM</div><div id="baseMxn" class="mxn-big">$0 MXN</div><div id="baseUsd" class="usd-small">$0 USD</div><div id="rateTxt" style="font-size:9px;color:#FFD700;margin-top:6px"></div><div id="diaTxt" style="font-size:10px;color:#5a7aa5;margin-top:2px"></div></div></div>')
    parts.append('<div class="card" style="border:2px solid #00ff88"><div style="text-align:center;color:#8aa;font-size:9px;letter-spacing:3px">ACUMULADO NETO REAL</div><div id="acumMxn" class="acum-mxn">$0 MXN</div><div id="acumUsd" class="acum-usd">$0 USD</div><div id="totalLine" style="text-align:center;color:#5a7aa5;font-size:10px;margin-top:6px"></div><div id="costoLine" class="comp"></div><div id="costoUsdLine" style="text-align:center;color:#5a7aa5;font-size:10px"></div><div style="text-align:center;color:#FFD700;font-size:9px;margin-top:6px">BASE 500 USD FIJA + ACUM EN USD x RATE MXN = TOTAL - BOLA DE NIEVE ORIGINAL</div></div>')
    parts.append('<div class="card" style="border:1px solid #00ff88"><b style="color:#00ff88">TP 0,3% NETO REAL</b><br><br><button class="btn tp" onclick="doTP(0.3)">0,3%</button><button class="btn tp" onclick="doTP(0.4)">0,4%</button><button class="btn tp
